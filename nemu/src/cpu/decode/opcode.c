...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, inv, inv, and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b};
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, inv, inv, and_i2rm_bv, sub_i2rm_bv, xor_i2rm_bv, cmp_i2rm_bv};
