...
instr_func opcode_entry[256] = {
    ...
    /* 0x70 - 0x73*/ jo_short_, jno_short_, jb_short_, jna_short_,
...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, inv, inv, inv, and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, inv, inv, inv, and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v};
...
instr_func group_3_b_entry[8] =
    {test_r2rm_b, inv, not_rm_b, inv, mul_rm2a_b, imul_rm2a_b, inv, idiv_rm2a_b};
